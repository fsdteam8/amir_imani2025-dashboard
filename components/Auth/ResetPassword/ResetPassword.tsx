...
export default function ResetPassword() {
  ...
  return (
    <div className="flex items-center justify-center w-full max-w-[756px] shadow-lg rounded-lg p-6">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-12 gradient-primary hover:bg-red-800 text-white font-semibold rounded-md cursor-pointer font-heading text-base"
            >
